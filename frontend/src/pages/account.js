...
export default function Account(){
    ...
    //                             </div>
    //                             <div className='editDetialsInput'>
    //                                 <TextField required name='name' sx={{width:'100%'}} className='accountInput' placeholder="Name" type='text' />
    //                             </div>
    //                         </Col>
    //                     </Row>
    //                     <Row>
    ...
    //                             </div>
    //                             <div className='editDetialsInput'>
    //                                 <TextField required name='emailAddress' sx={{width:'100%'}} className='accountInput' placeholder="Email Address" type='text' />
    //                             </div>
    //                         </Col>
    //                     </Row>
    //                     <Row>
    ...
    //                             </div>
    //                             <div className='editDetialsInput'>
    //                                 <TextField required name='password' sx={{width:'100%'}} className='accountInput' placeholder="Current Password" type='text' />
    //                             </div>
    //                         </Col>
    //                     </Row>
    //                     <Row>
    ...
    //                             </div>
    //                             <div className='editDetialsInput'>
    //                                 <TextField required name='newPassword' sx={{width:'100%'}} className='accountInput' placeholder="Current Password" type='text' />
    //                             </div>
    //                         </Col>
    //                     </Row>
    //                     <Row>
    ...
    //                             </div>
    //                             <div className='editDetialsInput'>
    //                                 <TextField required name='cfmPassword' sx={{width:'100%'}} className='accountInput' placeholder="Confirm New Password" type='text' />
    //                             </div>
    //                         </Col>
    //                     </Row>
    //                 </Container>
    ...
    //                 <div className='editDetailsButtonRow'>
    //                     <button className='saveEditChanges'>
    //                         Save Changes
    //                     </button>
    //                 </div>
    //             </div>
